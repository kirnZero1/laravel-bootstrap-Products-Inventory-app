                                    ...
                                    <div class='d-flex align-items-center justify-content-center '>
                                            <div class='col-8 border bg-white'>
                                                <div class='row p-2'>
                                                    ...
                                                    <div class='col-9'><input type='text' name="name" class='form-control' placeholder="Enter Product Name" value="{{old('name')}}" /></div>
                                                    @error('name')
                                                ...
                                                <div class='row p-2'>
                                                    ...
                                                    <div class='col-9'><input type='integer' name="qty" class='form-control' placeholder="Enter Product Quantity" value="{{old('qty')}}" /></div>
                                                    @error('qty')
                                                    <div class='text-danger text-center'>{{$message}}</div>
                                                     @enderror
                                                </div>
                                                <div class='row p-2'>
                                                    ...
                                                    <div class='col-9'><input type='decimal' name="price" class='form-control' placeholder="Enter Product Price" value="{{old('price')}}" /></div>
                                                    @error('price')
                                                    <div class='text-danger text-center'>{{$message}}</div>
                                                    @enderror
                                                </div>
                                                <div class='row p-2'>
                                                    ...
                                                    <div class='col-9'><textarea name='description' class='form-control' placeholder="Enter  product description">{{old('description')}}</textarea></div>
                                                    @error('description')
                                                            <div class='text-danger text-center'>{{$message}}</div>
                                                    @enderror
                                                </div>
